 ...
 ******************************************************************************/
    ...
    **************************************************************************/
        ...
        #define TRC_REG_DEMCR (*(volatile unsigned int *)0xE000EDFC)
        #define TRC_REG_DWT_CTRL (*(volatile unsigned int *)0xE0001000)
        #define TRC_REG_DWT_CYCCNT (*(volatile unsigned int *)0xE0001004)
        #define TRC_REG_DWT_EXCCNT (*(volatile unsigned int *)0xE000100C)

        #define TRC_REG_ITM_LOCKACCESS (*(volatile unsigned int *)0xE0001FB0)		
        ...
        #define TRC_HWTC_COUNT (*((volatile unsigned int *)0xE000E018))
        #define TRC_HWTC_PERIOD ((*((volatile unsigned int *)0xE000E014)) + 1)
        #define TRC_HWTC_DIVISOR 4
        #define TRC_HWTC_FREQ_HZ TRACE_CPU_CLOCK_HZ
        #define TRC_IRQ_PRIORITY_ORDER 0
    ...
    #define TRC_RTIFRC0 *((unsigned int  *)0xFFFFFC10)
    #define TRC_RTICOMP0 *((unsigned int  *)0xFFFFFC50)
    #define TRC_RTIUDCP0 *((unsigned int  *)0xFFFFFC54)
    ...
    #define TRC_HWTC_TYPE TRC_OS_TIMER_INCR
    #define TRC_HWTC_COUNT ((unsigned int )(AT91C_BASE_PITC->PITC_PIIR & 0xFFFFF))
    #define TRC_HWTC_PERIOD ((unsigned int )(AT91C_BASE_PITC->PITC_PIMR + 1))
    #define TRC_HWTC_DIVISOR 1
    #define TRC_HWTC_FREQ_HZ (TRACE_TICK_RATE_HZ * TRC_HWTC_PERIOD)
    #define TRC_IRQ_PRIORITY_ORDER 1
    ...
    #define TRC_HWTC_TYPE TRC_OS_TIMER_INCR
    #define TRC_HWTC_COUNT ((unsigned int )sysreg_read(AVR32_COUNT))
    #define TRC_HWTC_PERIOD ((unsigned int )(sysreg_read(AVR32_COMPARE) + 1))
    #define TRC_HWTC_DIVISOR 1
    #define TRC_HWTC_FREQ_HZ (TRACE_TICK_RATE_HZ * TRC_HWTC_PERIOD)
    #define TRC_IRQ_PRIORITY_ORDER 1
    ...
    #define TRC_HWTC_TYPE TRC_OS_TIMER_INCR
    #define TRC_HWTC_COUNT *((unsigned int  *)0xE0004008 )
    #define TRC_HWTC_PERIOD *((unsigned int  *)0xE0004018 )
    #define TRC_HWTC_DIVISOR 1
    #define TRC_HWTC_FREQ_HZ (TRACE_TICK_RATE_HZ * TRC_HWTC_PERIOD)
    #define TRC_IRQ_PRIORITY_ORDER 0
    ...
    #define TRC_HWTC_TYPE          TRC_OS_TIMER_INCR
    #define TRC_HWTC_COUNT         (unsigned int )alt_timestamp()
    ...
    #define TRC_CA9_MPCORE_PRIVCTR_PERIOD_REG   (*(volatile unsigned int *)(TRC_CA9_MPCORE_PERIPHERAL_BASE_ADDRESS + TRC_CA9_MPCORE_PRIVATE_MEMORY_OFFSET + 0x00))
    #define TRC_CA9_MPCORE_PRIVCTR_COUNTER_REG  (*(volatile unsigned int *)(TRC_CA9_MPCORE_PERIPHERAL_BASE_ADDRESS + TRC_CA9_MPCORE_PRIVATE_MEMORY_OFFSET + 0x04))
//    #define TRC_CA9_MPCORE_PRIVCTR_CONTROL_REG  (*(volatile unsigned int *)(TRC_CA9_MPCORE_PERIPHERAL_BASE_ADDRESS + TRC_CA9_MPCORE_PRIVATE_MEMORY_OFFSET + 0x08))
...
#elif (TRC_CFG_HARDWARE_PORT == TRC_HARDWARE_PORT_RISCV)
  // #include "portmacro.h"
  // TickType_t xTaskGetTickCount( void );
    /* Timestamping by OS tick only (typically 1 ms resolution) */
    #define TRC_HWTC_TYPE TRC_OS_TIMER_INCR
    #define TRC_HWTC_COUNT (xTaskGetTickCountFromISR())
    #define TRC_HWTC_PERIOD (TRACE_CPU_CLOCK_HZ / TRACE_TICK_RATE_HZ)
    #define TRC_HWTC_DIVISOR 4
    #define TRC_HWTC_FREQ_HZ TRACE_CPU_CLOCK_HZ
    #define TRC_IRQ_PRIORITY_ORDER 1
