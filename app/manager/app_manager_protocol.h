...
unsigned char *manager_create_change_addr_respond_data(unsigned int old_addr, unsigned int new_addr);
void manager_delete_change_addr_respond_data(unsigned char *data);
