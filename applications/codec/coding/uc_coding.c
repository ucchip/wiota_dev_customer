    ...
    if (input_data_len > offset)
    {
        ...
        *(buf + buf_len) = 0;
        ...
        if (compress_flag == 1)
        {
            ...
            // rt_kprintf("decomp data len.bef %d after %d\n", buf_len, decomp_data_len);
                                     ...
                                     unsigned char **output_data)
{
    ...
    else
    {
        ...
        rt_memset(decode_data, 0, sizeof(app_ps_auth_req_t));
    }
    ...
    rt_memcpy(decode_data->aut_code, cb_data->v.str, cb_data->length);
                                     ...
                                     unsigned char **output_data)
{
...
#endif
    {
        ...
        rt_memset(decode_data, 0, sizeof(app_ps_auth_res_t));
    }
                                           ...
                                           unsigned char **output_data)
{
...
#endif
    {
        ...
        rt_memset(decode_data, 0, sizeof(app_ps_version_verify_t));
    }
    ...
    rt_memcpy(decode_data->software_version, cb_data->v.str, cb_data->length);
    ...
    rt_memcpy(decode_data->hardware_version, cb_data->v.str, cb_data->length);
    ...
    rt_memcpy(decode_data->device_type, cb_data->v.str, cb_data->length);
                                            ...
                                            unsigned char **output_data)
{
...
#endif
    {
        ...
        rt_memset(decode_data, 0, sizeof(app_ps_ota_upgrade_req_t));
    }
    ...
    rt_memcpy(decode_data->new_version, cb_data->v.str, cb_data->length);
    ...
    rt_memcpy(decode_data->old_version, cb_data->v.str, cb_data->length);
    ...
    rt_memcpy(decode_data->md5, cb_data->v.str, cb_data->length);
    ...
    rt_memcpy(decode_data->data, cb_data->v.str, cb_data->length);
                                             ...
                                             unsigned char **output_data)
{
...
#endif
    {
        ...
        rt_memset(decode_data, 0, sizeof(app_ps_ota_upgrade_stop_t));
    }
                                              ...
                                              unsigned char **output_data)
{
...
#endif
    {
        ...
        rt_memset(decode_data, 0, sizeof(app_ps_ota_upgrade_state_t));
    }
                                          ...
                                          unsigned char **output_data)
{
...
#endif
    {
        ...
        rt_memset(decode_data, 0, sizeof(app_ps_iote_missing_data_req_t));
    }
                                              ...
                                              unsigned char **output_data)
{
...
#endif
    {
        ...
        rt_memset(decode_data, 0, sizeof(app_ps_iote_state_update_t));
    }
                                                ...
                                                unsigned char **output_data)
{
    ...
    else
    {
        ...
        rt_memset(decode_data, 0, sizeof(int));
    }
